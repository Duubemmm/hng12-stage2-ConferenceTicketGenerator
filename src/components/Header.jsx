...
const Header = () => {
  return (
    <header className="fixed top-2 w-[90%] flex items-center border border-ticz rounded-lg mx-auto ">
      <div className="w-full flex items-center justify-between py-1">
        ...
        <nav className="hidden sm:flex flex-grow justify-center space-x-8">
          <a href="#" className="text-white hover:text-green-400 transition">Events</a>
          <a href="#" className="text-white hover:text-green-400 transition">My Tickets</a>
          <a href="#" className="text-white hover:text-green-400 transition">About Project</a>
        </nav>

        {/* Right Section - Ticket Button */}
        <div className="flex items-center">
          <button className="flex items-center bg-white text-black rounded-lg pl-2 shadow-md mr-2 font-medium">
            MY TICKETS
